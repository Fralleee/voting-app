...
export default function Page() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center flex-grow py-8 gap-8">
        <div className="w-full flex flex-col items-center justify-center overflow-hidden rounded-md">
          <Prompts />
          <h1 className="mt-6 md:text-7xl text-3xl lg:text-9xl font-bold text-center text-stone-700 dark:text-slate-200 relative z-20">{title}</h1>
