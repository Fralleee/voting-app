...
export const Gradient = () => {
  return (
    ...
    >
      <div className="absolute inset-x-0 top-0 h-[2px] w-full bg-gradient-to-r from-transparent via-pink-400 to-transparent blur-sm dark:via-indigo-200" />
      ...
      <div className="absolute left-1/4 right-1/4 top-0 h-1 w-1/2 bg-gradient-to-r from-transparent via-red-400 to-transparent blur-sm dark:h-[5px] dark:via-sky-400" />
