  ...
  return (
    <div
      ...
      <ul
        ...
        {items.map(item => (
          <li className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-stone-700 dark:border-slate-500 px-8 py-6 md:w-[450px]" key={item.name}>
            <blockquote>
