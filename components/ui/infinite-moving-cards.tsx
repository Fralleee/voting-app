        ...
        {items.map((item, idx) => (
          <li
            ...
            <blockquote>
              ...
              <span className=" relative z-20 text-sm leading-[1.6] text-neutral-950 dark:text-neutral-100 font-normal">{item.quote}</span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className=" text-sm leading-[1.6] text-neutral-600 dark:text-neutral-400 font-normal">{item.name}</span>
                  <span className=" text-sm leading-[1.6] text-neutral-600 dark:text-neutral-400 font-normal">{item.title}</span>
                </span>
              </div>
            </blockquote>
          </li>
